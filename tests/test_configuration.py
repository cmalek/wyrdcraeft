...
class TestConfiguration:
    ...
    def test_default_settings(self):
        ...
        with patch(
            "oe_json_extractor.settings.Settings.model_config",
            {"extra": "ignore", "env_prefix": "OE_JSON_EXTRACTOR_"},
        ):
            settings = Settings()
    ...
    @patch("oe_json_extractor.settings.Path.home")
    ...
    def test_load_config_without_toml_file(self):
        ...
        with patch("oe_json_extractor.settings.Settings.model_config", {"toml_file": []}):
            settings = Settings()
    ...
    def test_load_config_error(self):
        ...
        with (  # noqa: SIM117
            ...
            patch(
                "oe_json_extractor.settings.Settings.__init__",
    ...
    def test_settings_model_config(self):
        ...
        assert settings.model_config.get("env_prefix") == "OE_JSON_EXTRACTOR_"
    ...
    def test_settings_with_environment_variables(self):
        ...
        with (
            patch.dict(
                "os.environ",
                {
                    "OE_JSON_EXTRACTOR_YOUR_ENV_VAR": "value",
                },
            ),
            patch(
                "oe_json_extractor.settings.Settings.model_config",
    ...
    def test_settings_environment_variable_override(self):
        ...
        with (
            patch.dict(
                "os.environ",
                {
                    "OE_JSON_EXTRACTOR_DEFAULT_OUTPUT_FORMAT": "json",
