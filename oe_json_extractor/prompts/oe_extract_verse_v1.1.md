...
Additional instruction (verse mode):
- Treat the input as VERSE/POETRY. Prefer lines. Do not output paragraphs.
- Preserve each line break as a separate line when possible.
