...
def _gen_sunu_duru(
    ...
    Note:
        ...
        ``data/Ondej_Tich_40-54-1.pdf``. In plain terms, this emits noun Part-
...
def _gen_bealu(
    ...
    Note:
        Neuter wa-stem noun behavior follows ``data/OldEnglishGrammar.pdf`` and
        ``data/Ondej_Tich_40-54-1.pdf``. In plain terms, this emits noun Part-
...
def _gen_frea(
    ...
    Note:
        Weak n-stem noun behavior follows ``data/OldEnglishGrammar.pdf`` and
        ``data/Ondej_Tich_40-54-1.pdf``. In plain terms, this emits noun Part-
